defmodule Prismatic.LLM.Backend.MetricsCollector do
  ...
  @spec init_backend_metrics() :: backend_metrics()
  ...
  @spec update_backend_metrics(map(), backend_name(), request_result(), request_data(), integer()) :: map()
  ...
  @spec update_global_metrics(global_metrics(), request_result(), request_data(), integer()) :: global_metrics()
  ...
  # Additional private helper functions would continue here...
  # (Implementing the remaining update functions with proper specs and documentation)

  @spec increment_request_count(map(), request_result()) :: map()
  ...
  @spec update_latency_metrics(map(), request_data()) :: map()
  ...
  @spec update_token_metrics(map(), request_data()) :: map()
  ...
  @spec update_cost_metrics(map(), request_data()) :: map()
  ...
  @spec update_error_metrics(map(), request_result(), request_data()) :: map()
  ...
  @spec update_timestamps(map(), request_result(), integer()) :: map()
  ...
  @spec update_global_timestamps(map(), integer()) :: map()
  defp update_global_timestamps(metrics, timestamp) do
    %{metrics | last_request_time: timestamp}
  end

  @spec calculate_derived_metrics(backend_metrics()) :: backend_metrics()
  ...
  @spec calculate_global_derived_metrics(global_metrics()) :: global_metrics()
  ...
  @spec calculate_health_score(backend_metrics()) :: float()
  ...
  @spec update_circuit_breaker_metrics(map(), backend_name(), circuit_breaker_event(), integer()) :: map()
  ...
  @spec calculate_running_average(float(), number(), pos_integer()) :: float()
