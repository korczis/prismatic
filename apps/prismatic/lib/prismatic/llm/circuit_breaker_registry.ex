defmodule Prismatic.LLM.CircuitBreakerRegistry do
  @moduledoc """
  Registry for LLM backend circuit breakers.

  This module provides a centralized registry for managing circuit breaker
  processes across different LLM backends. It ensures that each backend
  ...
  ## Examples
      ...
      # Start the registry
      {:ok, _pid} = Prismatic.LLM.CircuitBreakerRegistry.start_link()

      # Register a circuit breaker (done automatically by CircuitBreaker)
      Registry.register(Prismatic.LLM.CircuitBreakerRegistry, :openai, nil)

      # Lookup circuit breaker processes
      [{pid, _}] = Registry.lookup(Prismatic.LLM.CircuitBreakerRegistry, :openai)
  """
  ...
  ## Examples
      ...
      iex> {:ok, pid} = Prismatic.LLM.CircuitBreakerRegistry.start_link()
      iex> is_pid(pid)
      true
  """
  ...
  ## Examples
      ...
      children = [
        Prismatic.LLM.CircuitBreakerRegistry.child_spec([])
      ]
  """
